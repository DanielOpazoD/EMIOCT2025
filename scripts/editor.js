...
export async function initializeEditor() {
      ...
      function printVisibleFloatingNotes() {
        ...
        const pageDimensions = FLOATING_NOTES_PRINT_PAGE_DIMENSIONS_MM[pageSizeSetting]
          || FLOATING_NOTES_PRINT_PAGE_DIMENSIONS_MM[FLOATING_NOTES_PRINT_DEFAULTS.pageSize];
        const orientedWidthMm = orientationSetting === 'landscape'
          ? pageDimensions.height
          : pageDimensions.width;
        const orientedHeightMm = orientationSetting === 'landscape'
          ? pageDimensions.width
          : pageDimensions.height;
        const pageWidthPx = orientedWidthMm * pxPerMillimetre;
        const pageHeightPx = orientedHeightMm * pxPerMillimetre;
